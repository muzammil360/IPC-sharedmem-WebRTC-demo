...
function websocketServerConnect() {
    ...
    setStatus("Muz: Connecting to server " + ws_url);
...
const handleDataChannelMessageReceived = (event) =>{
    ...
    setStatus("Received data channel message. use WASD to move square");
...
function onDataChannel(event) {
    setStatus("receive data channel created");
...
function createCall(msg) {
    ...
    send_channel = peer_connection.createDataChannel('send-channel', null);
